...
/**
 * this is a copy of the file profile-block.tpl.php it has some minor adaptations.
 * instead of being used to theme the "Author Information" block
 * is used to theme the "About the User" Block
 * 
 * @file about-user.tpl.php
...
<?php foreach ($profile as $field) : ?>
  <div class="profile-field profile-field-<?php print strtolower(str_replace(" ", "_", $field->title)); ?> profile-field-type-<?php print $field->type; ?>">
