...
(function($){
  ...
  var methods = {
    ...
    "collapse" : function(){
      ...
      var newHeight = $(this).parent().find(".ui-dialog-titlebar").height()+15;
      //start!
      $(self)
    ...
    "restore" : function(){
       ...
       * FIX_ELOY
       */
      if (beforeState == "maximized" ||
        beforeState == "minimized" || 
        beforeState == "collapsed") {
        //start!  
        $(self)
        //trigger custom event
    ...
    "_initButtons" : function(){
       ...
       */
      var titlebar = $(self).parent().find(".ui-dialog-titlebar");
      $(titlebar)
      ...
      .css({
        "right" : settings.maximize ? "1.4em" : "-9999em"
      })
      .click(function(e){
        e.preventDefault();
      ...
      .css({
        "right" : settings.maximize ? "2.5em" : settings.minimize ? "1.4em" : "-9999em"
      })
      .click(function(e){
        e.preventDefault();
      ...
      switch ( settings.titlebar ) {
        ...
        case "none":
          ...
          if ( $(self).dialog("option", "draggable") ) {
            ...
            $(self).parent().prepend(handle).draggable("option", "handle", handle);
          }
    ...
    "_saveSnapshot" : function(){
      ...
      if ( $(self).data("dialog-state") == "normal" ) {
        ...
        .data("original-size-height", $(self).parent().height())
        .data("original-size-width", $(self).dialog("option", "width"))
        .data("original-size-maxHeight", $(self).dialog("option", "maxHeight"))
        .data("original-position-mode", $(self).parent().css("position"))
        .data("original-position-left", $(self).parent().offset().left)
        .data("original-position-top", $(self).parent().offset().top)
        .data("original-titlebar-wrap", $(self).parent().find(".ui-dialog-titlebar").css("white-space"));
      }
      //maintain chainability
      return self;
    },
    ...
    "_toggleButtons" : function(){
      ...
      .css({
        "right" : $(self).data("dialog-state") == "maximized" ? "1.4em" : $(self).data("dialog-state") == "minimized" ? !settings.maximize ? "1.4em" : "2.5em" : "-9999em"
      })
      .end();
      //maintain chainability
      return self;
